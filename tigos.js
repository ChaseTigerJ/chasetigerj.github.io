...
window.TIG_ASSETS = {"apple_abe":"assets/apple_abe-74c520ba.webp","apple_story":"assets/apple_story-ab08fad7.webp","eb_banner":"assets/eb_banner-75b8347f.webp","eb_desktop":"assets/eb_desktop-ffaab384.webp","eb_phones":"assets/eb_phones-22b048b3.webp","guns":"assets/guns-66ed52d2.glb","headshot":"assets/headshot-e073c9c4.webp","hub_email2":"assets/hub_email2-571e2eab.webp","hub_email4":"assets/hub_email4-d939ee7c.webp","hub_packet":"assets/hub_packet-2c59872a.webp","hub_support":"assets/hub_support-a75baba2.webp","jm_email":"assets/jm_email-1cab3011.webp","jm_menu":"assets/jm_menu-054d3d33.webp","jm_photo":"assets/jm_photo-3ae1b18a.webp","props":"assets/props-b05c2297.glb","resume_pdf":"assets/resume_pdf-dd13bd5c.pdf","resume_preview":"assets/resume_preview-b3284045.webp","three":"assets/three-fef2a638.js","tig_aleppo":"assets/tig_aleppo-ed307995.webp","tig_mba":"assets/tig_mba-2622ce0c.webp","tig_site":"assets/tig_site-82ca23e5.webp","train":"assets/train-04b6f1c5.glb","wraith":"assets/wraith-04534956.glb","zombie":"assets/zombie-70ef7ba1.glb","games":"assets/games-e501b7c3.js","nightshift":"assets/nightshift-4b2f1d0c.js","rounds":"assets/rounds-d07c9c89.js"};
...
/* tigOS core app.js, part 14: arcade. The parts in this folder are concatenated in name order by build.py, so they share one scope. */
  ...
  RENDER.games = function(w){
    ...
    function play(id){
      ...
      stage.addEventListener('pointerdown', function(e){ if(e.target.closest('.gm-over button, .gm-over input, .gm-over select, .gm-over label, .gm-over output, .gm-ui')) return;   /* a title card may carry settings controls; .gm-ui is a game's own menu */ stage.focus({ preventScroll:true }); if(state.over) return; if(state.paused){ pause(false); return; } if(state.ready){ begin(); if(cur && cur.wake) try { cur.wake(); } catch(x){} return; }   /* the click that dismisses "press any key" only starts the game: it never reaches the frog */ var p = pt(e); sw = { x:e.clientX, y:e.clientY, t:Date.now() }; if(cur) cur.pointer('down', p.x, p.y, e); });
